...
const lookupCache = new Map<string, { payload: FlightAwareFlightEnrichment | null; expiresAt: number }>();
      ...
      return {
        ...
        report: cachedEntry.payload
          ? createFlightAwareReport(
              ...
              true,
              { identifier: normalizedIdentifier, cached: true, match: summarizeFlightAwareMatch(cachedEntry.payload) },
            )
          : createFlightAwareReport(
              'no-data',
