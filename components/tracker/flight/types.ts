...
export type FlightDataSource = 'opensky' | 'aviationstack' | 'flightaware' | 'airlabs' | 'aerodatabox' | 'hybrid';
export type FlightFetchTrigger = 'search' | 'auto-refresh' | 'manual-refresh';
export type FlightSourceName = 'opensky' | 'aviationstack' | 'flightaware' | 'airlabs' | 'aerodatabox';
